    ...
    steps:[
      ...
      {type:'action', emoji:"🔑", kicker:"Guichet 6 · 🔑 clé 2/2",
       ...
       slider:[
         ...
         {src:"shots/token/13.png", cap:"Ton token apparaît : clique « Copier » et range-le en lieu sûr. 🔒 Ne le montre JAMAIS à personne."}
       ],
       say:`Ce badge n'expire jamais. Configuré une fois, tranquille pour toujours 🎯`,
       hint:`Le token est comme la clé de ta maison : si quelqu'un l'a, il peut publier à ta place. Ne le colle jamais dans un message, un mail ou un site.`,
