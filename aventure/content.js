  ...
  { id:1, title:"Tes clés", sub:"Créer (ou retrouver) tes comptes", emoji:"🔑",
    ...
    steps:[
      ...
      {type:'action', emoji:"📘", kicker:"Mission · action",
       ...
       msg:`Sur ton ordinateur (facebook.com). Avance avec les flèches 👇`,
       slider:[
         ...
         {src:"shots/facebook/6.png", cap:"Bravo ! Ton compte Facebook est créé. 🎉"}
       ],
  ...
  { id:3, title:"Les clés magiques de Meta", sub:"Le sésame qui publie pour toi", emoji:"🗝️",
    ...
    steps:[
      ...
      {type:'action', emoji:"🔗", kicker:"Guichet 5",
       ...
       slider:[
         {src:"shots/fbpage/1.png",  cap:"Dans Facebook, ouvre le menu et clique sur « Pages »."},
         {src:"shots/fbpage/2.png",  cap:"Clique sur « Créer une Page »."},
         {src:"shots/fbpage/3.png",  cap:"Choisis « Page professionnelle »."},
         {src:"shots/fbpage/4.png",  cap:"Lis l'explication, puis clique sur « Commencer »."},
         {src:"shots/fbpage/5.png",  cap:"Écris le nom de ta Page et choisis une catégorie."},
         {src:"shots/fbpage/6.png",  cap:"Vérifie que tout est bon, puis clique sur « Créer une Page »."},
         {src:"shots/fbpage/7.png",  cap:"Complète les infos de ta Page (site, téléphone, e-mail, adresse) — tu peux passer."},
         {src:"shots/fbpage/8.png",  cap:"Ajoute une photo de profil et une photo de couverture, puis « Suivant »."},
         {src:"shots/fbpage/9.png",  cap:"WhatsApp : tu peux ignorer cette étape."},
         {src:"shots/fbpage/10.png", cap:"Inviter des ami(e)s : tu peux passer, puis « Suivant »."},
         {src:"shots/fbpage/11.png", cap:"Choisis tes notifications, puis « Suivant »."},
         {src:"shots/fbpage/12.png", cap:"Bravo ! Ta Page Facebook est prête. 🎉"}
       ],
