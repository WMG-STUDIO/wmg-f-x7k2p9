    ...
    steps:[
      ...
      {type:'action', emoji:"📨", kicker:"Mission · action",
       ...
       slider:[
         ...
         {src:"shots/gmail/7.png",  cap:"Ouvre l'appareil photo de ton téléphone et scanne le carré."},
         {src:"shots/gmail/8.png",  cap:"Sur ton téléphone, appuie sur « Envoyer » pour envoyer le SMS."},
         {src:"shots/gmail/9.png",  cap:"Tu peux ajouter un e-mail de secours, ou clique « Suivant »."},
         {src:"shots/gmail/10.png", cap:"Clique sur « J'accepte »."},
         {src:"shots/gmail/11.png", cap:"Bravo ! Voici ta boîte mail. « Nouveau message » sert à écrire un e-mail."}
       ],
